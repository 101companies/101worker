...
of \solatose{} with external web-based resources, e.g., pages on
...
of \uri{onto:sameAs} expresses that the \solatose{} individual and the
...
The use of \uri{onto:similarTo} expresses that the \solatose{}
...
enabled by \uri{onto:linksTo}, but such links are not encouraged. We
query some links for illustration:

\sparql{predicateSameAs2}

\completeOutputTabular{{l|l|l}}{\textbf{predicate} & \textbf{url}}{predicateSameAs2}
