...
define('WIKI_101_SCHEMA_URL',ABSPATH_WORKER_CONFIG_DIR.'Wiki101Schema.ers') ;
define('WIKI_101_ENTITY_JSON_MAPPING_URL',ABSPATH_WORKER_CONFIG_DIR.'Wiki101EntityKindToWiki101JsonTopLevelTag.json') ;

define('DOMAIN_DATA_101','data'.DOMAIN_PROJECT_101) ;
define('RDF_DATA_101_URL','http://'.DOMAIN_DATA_101) ;

define('RDF_DATA_101_PREFIX','d101') ;
define('RDF_DATA_101_URI_PATTERN',RDF_DATA_101_URL.'/data/${type}/${id}') ;
